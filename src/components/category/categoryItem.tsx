const CategoryItem = () => {
  return (
    <div
      className="mt-8 grid grid-cols-2 gap-6 md:grid-cols-6 items-center"
      id="frameworks-integration"
    >
      <a
        className="grid w-full item-center min-w-[7rem] transform cursor-pointer place-items-center rounded-xl border border-blue-gray-50 bg-white px-3 py-2 transition-all hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25"
        href="#"
      >
        <span className="my-6 grid h-24 w-24 place-items-center">
          ...
          <p className="font-bold text-xl"> Tecnologia</p>
        </span>
      </a>
      <a
        className="grid w-full item-center min-w-[7rem] transform cursor-pointer place-items-center rounded-xl border border-blue-gray-50 bg-white px-3 py-2 transition-all hover:scale-105 hover:border-blue-gray-100 hover:bg-blue-gray-50 hover:bg-opacity-25"
